...
# Postman
 Создал  [коллекцию](https://github.com/Mixarder/Postman_Traning_DummyAPI) автоматизированных тестов, правда для тренировочного сайта, к можалению не довелось поработать <br> с реальными данными, но вы всегда можете дать мне тестовое задание.
